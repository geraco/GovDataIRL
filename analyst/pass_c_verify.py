...
a draft narrative and the statistical profile it was supposedly written from.
...
in the profile. Be strict: an unsupported or misremembered number is a
failure even if it's close to correct.
...
def verify_narrative(narrative: dict, profile: dict) -> dict:
    user_content = (
